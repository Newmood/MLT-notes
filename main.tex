...
\end{align}
The equation above can be thought of as a decision boundary for the clusters with means $\mu_1$ and $\mu_i$.  Additionally, its worth noticing that the separation between any two clusters is linear. 
